    ...
    <footer className="border-t border-stellar-border bg-stellar-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              {[
                { Icon: ExternalLink, href: 'https://github.com/Alouzious/StellarIDE', label: 'GitHub' },
        ...
        <div className="mt-12 pt-8 border-t border-stellar-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-stellar-muted">&copy; {year} StellarIDE. All rights reserved.</p>
          <p className="text-sm text-stellar-muted">
            Built for the{' '}
            <a href="https://stellar.org" target="_blank" rel="noopener noreferrer" className="text-stellar-accent hover:underline">
              Stellar
            </a>{' '}
            ecosystem.
          </p>
