...
export default function LoginPage() {
  ...
  const [serverError, setServerError] = useState(
    searchParams.get('error') ? `OAuth error: ${searchParams.get('error')}` : ''
  )
  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-stellar-heading">Welcome back</h1>
        <p className="mt-1 text-sm text-stellar-muted">Sign in to your StellarIDE workspace</p>
      </div>
      ...
      <div className="card">
        ...
        <div className="relative flex items-center gap-3 mb-5">
          ...
          <span className="text-xs text-stellar-border">or sign in with email</span>
          <div className="flex-1 h-px bg-stellar-border" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="rounded border-stellar-border bg-stellar-surface text-stellar-accent focus:ring-stellar-accent" />
              <span className="text-stellar-muted">Remember me</span>
            </label>
            <a href="#" className="text-stellar-accent hover:underline">
              Forgot password?
            </a>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-stellar-muted">
          ...
          <Link to="/register" className="text-stellar-accent hover:underline font-medium">
            Create one free
          </Link>
        </p>
      </div>
