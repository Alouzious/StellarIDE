...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-px bg-stellar-border" />
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="space-y-5">
              ...
              <h1 className="text-5xl lg:text-6xl font-black text-stellar-heading leading-[1.08] tracking-tight">
                Write, Test &<br />
                Deploy Soroban<br />
                <span className="text-stellar-accent">Contracts</span>
              </h1>
          ...
          <div className="relative">
            <div className="relative bg-[#0d1117] rounded-xl border border-stellar-border overflow-hidden shadow-xl">
              ...
              <div className="p-5 font-mono text-xs leading-6">
                {CODE_LINES.map(({ n, code, cls }) => (
                  <div key={n} className="flex gap-4 hover:bg-white/[0.02] px-1 rounded">
                    <span className="text-stellar-border select-none w-4 text-right flex-shrink-0 text-[10px] mt-0.5">
                      {n}
                    </span>
